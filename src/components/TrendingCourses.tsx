...
import { TrendingCourseItem } from '@/constants'
    ...
    return (
        <section className='wrapper flex flex-col items-center gap-10'>
            ...
            <div className='flex items-start max-lg:flex-col xl:gap-6 lg:gap-0 gap-6 w-full'>
                <Link href="/" className='flex items-center xl:w-full max-lg:w-full group '>
                    <div className='xl:w-full lg:w-[450px] max-lg:w-full h-[950px] rounded-[12px] relative overflow-hidden flex items-end'>
                        ...
                        <div className='flex flex-col gap-2 p-6'>
                            <div className='flex flex-col z-10 group-hover:scale-90 transition-all group-hover:-translate-x-4 duration-500'>
                                <span className='font-bold xl:text-[100px] lg:text-[80px] text-gray-50 uppercase'>Angelina</span>
                                <span className='font-bold xl:text-[100px] lg:text-[80px] -translate-y-14 text-gray-50 uppercase'>Lee</span>
                            </div>
