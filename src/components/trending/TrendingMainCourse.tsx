...
const TrendingMaintrendingCourse = ({trendingCourse}: {trendingCourse: ThumbCourseProps}) => {
  return (
    <section className='flex flex-col w-full gap-4'>
            <div className='flex flex-col' id='hero'>
                <h1 className='md:text-[32px] text-[24px] font-semibold'>{trendingCourse.title}</h1>
                <div className='flex items-center gap-2'>
                    <span className='text-pink-600 md:text-[18px] text-[16px] font-medium'>{trendingCourse.fullName}</span>
                    <div className='flex items-center gap-2'>
                        <FaStar className='md:w-5 md:h-5 w-3 h-3 text-yellow-300' />
                        <span className='md:text-[16px] text-sm'>{trendingCourse.rating}</span>
                        <p className='md:text-[16px] text-sm text-gray-400'>({trendingCourse.totalRating.toLocaleString()} ratings)</p>
                    </div>
                </div>
            </div>
            ...
            <div className='flex max-lg:flex-col items-start lg:gap-8 gap-4'>
                <div className='w-full md:h-[500px] h-[300px] max-sm:h-[220px] rounded-[12px] relative overflow-hidden group'>
                    <Image src={trendingCourse.thumbUrl} alt={trendingCourse.title} width={1000} height={1000} className='absolute w-full h-full top-0 object-cover object-center md:block hidden group-hover:scale-105 transition-all duration-500' loading='lazy' sizes='100vw' />
                    <Image src={trendingCourse.thumbUrlMobile} alt={trendingCourse.title} width={1000} height={1000} className='absolute w-full h-full top-0 object-cover object-center md:hidden block' loading='lazy' sizes='100vw' />
                    ...
                    <div className='flex max-lg:items-center lg:flex-col flex-row max-lg:gap-3 gap-1 flex-wrap'>
                        <div className='flex items-center gap-2 flex-wrap-reverse'>
                            <span className='md:text-[28px] text-[24px] font-semibold'>
                                Rp. {trendingCourse.price.toLocaleString()}
                            </span>
                            <span className='font-semibold line-through md:text-[20px] text-[18px] text-gray-500'>
                                Rp. {trendingCourse.discount.toLocaleString()}
                            </span>
                        </div>
                        <div className='bg-pink-600 px-3 py-1 rounded-[4px] w-max flex-shrink-0'>
                            <span className='text-gray-50 font-medium text-sm'>{trendingCourse.discPercent} OFF</span>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col gap-2 lg:mt-4 mt-3'>
                        <div className='grid sm:grid-cols-2 lg:grid-cols-1 gap-5'>
                            <div className='flex items-center gap-4'>
                                ...
                                <span className='md:text-[18px] text-[16px] text-gray-500'>{trendingCourse.section} Sections</span>
                            </div>
                            <div className='flex items-center gap-4'>
                                <BsBook className='md:w-6 md:h-6 w-5 h-5 text-gray-500' />
                                <span className='md:text-[18px] text-[16px] text-gray-500'>{trendingCourse.lecture} Lectures</span>
                            </div>
                            <div className='flex items-center gap-4'>
                                <MdOutlineLiveTv className='md:w-6 md:h-6 w-5 h-5 text-gray-500' />
                                <span className='md:text-[18px] text-[16px] text-gray-500'>{trendingCourse.duration}</span>
                            </div>
                            <div className='flex items-center gap-4'>
                                <HiOutlineSpeakerWave className='md:w-6 md:h-6 w-5 h-5 text-gray-500' />
                                <span className='md:text-[18px] text-[16px] text-gray-500'>{trendingCourse.language}</span>
                            </div>
                            <div className='flex items-center gap-4'>
                                <HiMiniDevicePhoneMobile className='md:w-6 md:h-6 w-5 h-5 text-gray-500' />
                                <span className='md:text-[18px] text-[16px] text-gray-500'>{trendingCourse.access}</span>
                            </div>
                            <div className='flex items-center gap-4'>
                                <AiOutlineSafetyCertificate className='md:w-6 md:h-6 w-5 h-5 text-gray-500' />
                                <span className='md:text-[18px] text-[16px] text-gray-500'>{trendingCourse.certificate}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
export default TrendingMaintrendingCourse
