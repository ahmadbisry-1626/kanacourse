        ...
        <section className='flex items-center py-10 wrapper'>
            <div className='p-8 bg-[#1b283f] rounded-[12px] flex justify-center items-center w-full relative overflow-hidden group'>
                <div className='flex flex-col items-center justify-center gap-4 z-10 relative'>
                    ...
                    <p className='max-w-3xl text-gray-400 text-[20px] opacity-0 scale-90 group-hover:opacity-100 group-hover:scale-100 transition-all duration-700 text-center'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique, sit atque quia assumenda corrupti itaque illo nulla iure incidunt eaque.</p>
