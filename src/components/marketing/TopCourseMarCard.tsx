...
const TopCourseMarCard = ({ tm }: { tm: TmProps }) => {
    return (
        <Link href={`/marketing/${tm.id}/${encodeURIComponent(tm.title)}`} className='flex max-sm:flex-col gap-3 bg-gray-50 rounded-[12px] w-[620px] md:h-[350px] mt-6 hover:shadow-md transition-all duration-300 group overflow-hidden'>
